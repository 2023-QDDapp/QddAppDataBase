...
<body>
    <div style="text-align: center; padding: 20px;">
        ...
        <p style="font-size: 16px;"><strong>¡Bienvenido!</strong></p>
        <p style="font-size: 16px;">Por favor, pulsa en el siguiente botón para verificar tu dirección de correo electrónico:</p>
